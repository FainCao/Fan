(function(global, factory) {
    ...
    var stdin_default$1V = {
      ...
      vanCalendar: {
        ...
        monthTitle: (year, month) => `${year}骞�${month}鏈坄,
        rangePrompt: (maxRange) => `鏈€澶氶€夋嫨 ${maxRange} 澶ー
      },
      vanCascader: {
        select: "璇烽€夋嫨"
      },
      ...
      vanCoupon: {
        unlimited: "鏃犻棬妲�",
        discount: (discount) => `${discount}鎶榒,
        condition: (condition) => `婊�${condition}鍏冨彲鐢╜
      },
      vanCouponCell: {
        title: "浼樻儬鍒�",
        count: (count) => `${count}寮犲彲鐢╜
      },
      vanCouponList: {
        exchange: "鍏戞崲",
        close: "涓嶄娇鐢�",
    ...
    var stdin_default$12 = vue.defineComponent({
      ...
      setup(props2, {
        ...
        const renderContent = () => {
          ...
          return [vue.createVNode("div", null, [`${t$e("name")}锛�${props2.name}`]), vue.createVNode("div", null, [`${t$e("tel")}锛�${props2.tel}`])];
        };
        return () => vue.createVNode(Cell, {
          "center": true,
    ...
    var stdin_default$10 = vue.defineComponent({
      ...
      setup(props2, {
        ...
        const renderItem = (item, index) => {
          ...
          const renderContent = () => {
            const nodes = [`${item.name}锛�${item.tel}`];
